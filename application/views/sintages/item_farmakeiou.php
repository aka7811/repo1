...
<div class="container">
 ...
 {title:"Συνταγές", address:"/sintages/farmakeiou", active:false},
  {title:"Προβολή", address:"#", active:true}
 ]  }'  >
 
 </my-top-nav>
 

	<div  ng-init="init_sintagi_item(<?php echo $id?>)" ng-controller="Sintagi_Item_From_Farmakeio_Controller as sintagi">
